...
class Programa {
	...
	public static class removeVars extends tom.library.sl.AbstractStrategyBasic {private  java.util.List  unusedVars;public removeVars( java.util.List  unusedVars) {super(tom_make_Identity());this.unusedVars=unusedVars;}public  java.util.List  getunusedVars() {return unusedVars;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChildren = new tom.library.sl.Visitable[getChildCount()];stratChildren[0] = super.getChildAt(0);return stratChildren;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}@SuppressWarnings("unchecked")public <T> T visitLight(T v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (tom_is_sort_Instrucao(v)) {return ((T)visit_Instrucao((( gram.i.types.Instrucao )v),introspector));}if (!(( null  == environment))) {return ((T)any.visit(environment,introspector));} else {return any.visitLight(v,introspector);}}@SuppressWarnings("unchecked")public  gram.i.types.Instrucao  _visit_Instrucao( gram.i.types.Instrucao  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!(( null  == environment))) {return (( gram.i.types.Instrucao )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);}}@SuppressWarnings("unchecked")public  gram.i.types.Instrucao  visit_Instrucao( gram.i.types.Instrucao  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if (tom_is_sort_Instrucao(tom__arg)) {if (tom_is_sort_Instrucao((( gram.i.types.Instrucao )tom__arg))) {if (tom_is_fun_sym_Declaracao((( gram.i.types.Instrucao )(( gram.i.types.Instrucao )tom__arg)))) {
            	...
            	if(testeRemoveVars(unusedVars, tom_get_slot_Declaracao_Declaracoes((( gram.i.types.Instrucao )tom__arg))) == 1){
	...
	public static int testeRemoveVars(List<String> unusedVars, Declaracoes decls) {
		{{if (tom_is_sort_Declaracoes(decls)) {if (tom_is_fun_sym_ListaDecl((( gram.i.types.Declaracoes )(( gram.i.types.Declaracoes )decls)))) {if (!( ( tom_is_empty_ListaDecl_Declaracoes((( gram.i.types.Declaracoes )decls)) || tom_equal_term_Declaracoes((( gram.i.types.Declaracoes )decls), tom_empty_list_ListaDecl()) ) )) {
				...
				return testeRemoveVars(unusedVars,((tom_is_fun_sym_ListaDecl((( gram.i.types.Declaracoes )decls)))?(tom_get_head_ListaDecl_Declaracoes((( gram.i.types.Declaracoes )decls))):((( gram.i.types.Declaracoes )decls)))) + testeRemoveVars(unusedVars,((tom_is_fun_sym_ListaDecl((( gram.i.types.Declaracoes )decls)))?(tom_get_tail_ListaDecl_Declaracoes((( gram.i.types.Declaracoes )decls))):(tom_empty_list_ListaDecl())));
				...
				if (unusedVars.contains(tom_get_slot_Decl_Id((( gram.i.types.Declaracoes )decls)))){
					return 1;
				}
			}}}}}
...
//				System.out.println();
	...
	private String arvoreParaFicheiroArgumentos(Argumentos d) {
		{{if (tom_is_sort_Argumentos(d)) {if (tom_is_fun_sym_ListaArgumentos((( gram.i.types.Argumentos )(( gram.i.types.Argumentos )d)))) {if (!( ( tom_is_empty_ListaArgumentos_Argumentos((( gram.i.types.Argumentos )d)) || tom_equal_term_Argumentos((( gram.i.types.Argumentos )d), tom_empty_list_ListaArgumentos()) ) )) { gram.i.types.Argumentos  tomMatch14_2=((tom_is_fun_sym_ListaArgumentos((( gram.i.types.Argumentos )d)))?(tom_get_tail_ListaArgumentos_Argumentos((( gram.i.types.Argumentos )d))):(tom_empty_list_ListaArgumentos()));if (!( ( tom_is_empty_ListaArgumentos_Argumentos(tomMatch14_2) || tom_equal_term_Argumentos(tomMatch14_2, tom_empty_list_ListaArgumentos()) ) )) { gram.i.types.Argumentos  tomMatch14_3=((tom_is_fun_sym_ListaArgumentos(tomMatch14_2))?(tom_get_tail_ListaArgumentos_Argumentos(tomMatch14_2)):(tom_empty_list_ListaArgumentos()));if ( ( tom_is_empty_ListaArgumentos_Argumentos(tomMatch14_3) || tom_equal_term_Argumentos(tomMatch14_3, tom_empty_list_ListaArgumentos()) ) ) {
				...
				aux += ", \n";
				aux += arvoreParaFicheiroArgumentos(((tom_is_fun_sym_ListaArgumentos(tomMatch14_2))?(tom_get_head_ListaArgumentos_Argumentos(tomMatch14_2)):(tomMatch14_2)));

				return aux;
			}}}}}}{if (tom_is_sort_Argumentos(d)) {if (tom_is_fun_sym_ListaArgumentos((( gram.i.types.Argumentos )(( gram.i.types.Argumentos )d)))) {if (!( ( tom_is_empty_ListaArgumentos_Argumentos((( gram.i.types.Argumentos )d)) || tom_equal_term_Argumentos((( gram.i.types.Argumentos )d), tom_empty_list_ListaArgumentos()) ) )) { gram.i.types.Argumentos  tomMatch14_6=((tom_is_fun_sym_ListaArgumentos((( gram.i.types.Argumentos )d)))?(tom_get_tail_ListaArgumentos_Argumentos((( gram.i.types.Argumentos )d))):(tom_empty_list_ListaArgumentos()));if ( ( tom_is_empty_ListaArgumentos_Argumentos(tomMatch14_6) || tom_equal_term_Argumentos(tomMatch14_6, tom_empty_list_ListaArgumentos()) ) ) {
...
aux = "void ";}}}}}
	...
	private String arvoreParaFicheiroParametros(Parametros d) {
		{{if (tom_is_sort_Parametros(d)) {if (tom_is_fun_sym_ListaParametros((( gram.i.types.Parametros )(( gram.i.types.Parametros )d)))) {if (!( ( tom_is_empty_ListaParametros_Parametros((( gram.i.types.Parametros )d)) || tom_equal_term_Parametros((( gram.i.types.Parametros )d), tom_empty_list_ListaParametros()) ) )) { gram.i.types.Parametros  tomMatch16_2=((tom_is_fun_sym_ListaParametros((( gram.i.types.Parametros )d)))?(tom_get_tail_ListaParametros_Parametros((( gram.i.types.Parametros )d))):(tom_empty_list_ListaParametros()));if (!( ( tom_is_empty_ListaParametros_Parametros(tomMatch16_2) || tom_equal_term_Parametros(tomMatch16_2, tom_empty_list_ListaParametros()) ) )) { gram.i.types.Parametros  tomMatch16_3=((tom_is_fun_sym_ListaParametros(tomMatch16_2))?(tom_get_tail_ListaParametros_Parametros(tomMatch16_2)):(tom_empty_list_ListaParametros()));if ( ( tom_is_empty_ListaParametros_Parametros(tomMatch16_3) || tom_equal_term_Parametros(tomMatch16_3, tom_empty_list_ListaParametros()) ) ) {
				...
				aux += ", \n";
				aux += arvoreParaFicheiroParametros(((tom_is_fun_sym_ListaParametros(tomMatch16_2))?(tom_get_head_ListaParametros_Parametros(tomMatch16_2)):(tomMatch16_2)));
				return aux;
			}}}}}}{if (tom_is_sort_Parametros(d)) {if (tom_is_fun_sym_ListaParametros((( gram.i.types.Parametros )(( gram.i.types.Parametros )d)))) {if (!( ( tom_is_empty_ListaParametros_Parametros((( gram.i.types.Parametros )d)) || tom_equal_term_Parametros((( gram.i.types.Parametros )d), tom_empty_list_ListaParametros()) ) )) { gram.i.types.Parametros  tomMatch16_6=((tom_is_fun_sym_ListaParametros((( gram.i.types.Parametros )d)))?(tom_get_tail_ListaParametros_Parametros((( gram.i.types.Parametros )d))):(tom_empty_list_ListaParametros()));if ( ( tom_is_empty_ListaParametros_Parametros(tomMatch16_6) || tom_equal_term_Parametros(tomMatch16_6, tom_empty_list_ListaParametros()) ) ) {
	...
	public static class refactCondNeg extends tom.library.sl.AbstractStrategyBasic {public refactCondNeg() {super(tom_make_Identity());}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChildren = new tom.library.sl.Visitable[getChildCount()];stratChildren[0] = super.getChildAt(0);return stratChildren;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}@SuppressWarnings("unchecked")public <T> T visitLight(T v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (tom_is_sort_Instrucao(v)) {return ((T)visit_Instrucao((( gram.i.types.Instrucao )v),introspector));}if (!(( null  == environment))) {return ((T)any.visit(environment,introspector));} else {return any.visitLight(v,introspector);}}@SuppressWarnings("unchecked")public  gram.i.types.Instrucao  _visit_Instrucao( gram.i.types.Instrucao  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!(( null  == environment))) {return (( gram.i.types.Instrucao )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);}}@SuppressWarnings("unchecked")public  gram.i.types.Instrucao  visit_Instrucao( gram.i.types.Instrucao  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if (tom_is_sort_Instrucao(tom__arg)) {if (tom_is_sort_Instrucao((( gram.i.types.Instrucao )tom__arg))) {if (tom_is_fun_sym_If((( gram.i.types.Instrucao )(( gram.i.types.Instrucao )tom__arg)))) { gram.i.types.Expressao  tomMatch17_4=tom_get_slot_If_Condicao((( gram.i.types.Instrucao )tom__arg)); gram.i.types.LComentarios  tom_c1=tom_get_slot_If_c1((( gram.i.types.Instrucao )tom__arg)); gram.i.types.LComentarios  tom_c2=tom_get_slot_If_c2((( gram.i.types.Instrucao )tom__arg)); gram.i.types.LComentarios  tom_c3=tom_get_slot_If_c3((( gram.i.types.Instrucao )tom__arg));if (tom_is_sort_Expressao(tomMatch17_4)) {if (tom_is_fun_sym_Nao((( gram.i.types.Expressao )tomMatch17_4))) { gram.i.types.Expressao  tom_Expressao=tom_get_slot_Nao_Expressao(tomMatch17_4); gram.i.types.LComentarios  tom_c4=tom_get_slot_If_c4((( gram.i.types.Instrucao )tom__arg)); gram.i.types.LComentarios  tom_c5=tom_get_slot_If_c5((( gram.i.types.Instrucao )tom__arg)); gram.i.types.Instrucao  tom_then=tom_get_slot_If_Instrucao1((( gram.i.types.Instrucao )tom__arg)); gram.i.types.Instrucao  tom_els=tom_get_slot_If_Instrucao2((( gram.i.types.Instrucao )tom__arg));
