...
class Programa {
	...
	public static class removeVars extends tom.library.sl.AbstractStrategyBasic {private  java.util.List  unusedVars;public removeVars( java.util.List  unusedVars) {super(tom_make_Identity());this.unusedVars=unusedVars;}public  java.util.List  getunusedVars() {return unusedVars;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChildren = new tom.library.sl.Visitable[getChildCount()];stratChildren[0] = super.getChildAt(0);return stratChildren;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}@SuppressWarnings("unchecked")public <T> T visitLight(T v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (tom_is_sort_Instrucao(v)) {return ((T)visit_Instrucao((( gram.i.types.Instrucao )v),introspector));}if (!(( null  == environment))) {return ((T)any.visit(environment,introspector));} else {return any.visitLight(v,introspector);}}@SuppressWarnings("unchecked")public  gram.i.types.Instrucao  _visit_Instrucao( gram.i.types.Instrucao  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!(( null  == environment))) {return (( gram.i.types.Instrucao )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);}}@SuppressWarnings("unchecked")public  gram.i.types.Instrucao  visit_Instrucao( gram.i.types.Instrucao  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if (tom_is_sort_Instrucao(tom__arg)) {if (tom_is_sort_Instrucao((( gram.i.types.Instrucao )tom__arg))) {if (tom_is_fun_sym_Declaracao((( gram.i.types.Instrucao )(( gram.i.types.Instrucao )tom__arg)))) {



            	Declaracoes d = testeRemoveVars(unusedVars, tom_get_slot_Declaracao_Declaracoes((( gram.i.types.Instrucao )tom__arg)));
            	if(d == tom_empty_list_ListaDecl()){
            		return tom_make_Exp(tom_make_Empty());
            	}
            	else{
            		return tom_make_Declaracao(tom_get_slot_Declaracao_c1((( gram.i.types.Instrucao )tom__arg)),tom_get_slot_Declaracao_DefTipo((( gram.i.types.Instrucao )tom__arg)),tom_get_slot_Declaracao_c2((( gram.i.types.Instrucao )tom__arg)),d,tom_get_slot_Declaracao_c3((( gram.i.types.Instrucao )tom__arg)),tom_get_slot_Declaracao_c4((( gram.i.types.Instrucao )tom__arg)));
            	}
        	}}}}}return _visit_Instrucao(tom__arg,introspector);}}private static  tom.library.sl.Strategy  tom_make_removeVars( java.util.List  t0) { return new removeVars(t0);}



	public static Declaracoes testeRemoveVars(List<String> unusedVars, Declaracoes decls) {
		{{if (tom_is_sort_Declaracoes(decls)) {if (tom_is_fun_sym_ListaDecl((( gram.i.types.Declaracoes )(( gram.i.types.Declaracoes )decls)))) {if (!( ( tom_is_empty_ListaDecl_Declaracoes((( gram.i.types.Declaracoes )decls)) || tom_equal_term_Declaracoes((( gram.i.types.Declaracoes )decls), tom_empty_list_ListaDecl()) ) )) { gram.i.types.Declaracoes  tom_decl=((tom_is_fun_sym_ListaDecl((( gram.i.types.Declaracoes )decls)))?(tom_get_head_ListaDecl_Declaracoes((( gram.i.types.Declaracoes )decls))):((( gram.i.types.Declaracoes )decls))); gram.i.types.Declaracoes  tom_declss=((tom_is_fun_sym_ListaDecl((( gram.i.types.Declaracoes )decls)))?(tom_get_tail_ListaDecl_Declaracoes((( gram.i.types.Declaracoes )decls))):(tom_empty_list_ListaDecl()));{{if (tom_is_sort_Declaracoes(tom_decl)) {if (tom_is_sort_Declaracoes((( gram.i.types.Declaracoes )tom_decl))) {if (tom_is_fun_sym_Decl((( gram.i.types.Declaracoes )(( gram.i.types.Declaracoes )tom_decl)))) {





						if (unusedVars.contains(tom_get_slot_Decl_Id((( gram.i.types.Declaracoes )tom_decl)))){
							return testeRemoveVars(unusedVars, tom_declss);
						}
						else{
							return tom_cons_list_ListaDecl((( gram.i.types.Declaracoes )tom_decl),tom_cons_list_ListaDecl(testeRemoveVars(unusedVars,tom_declss),tom_empty_list_ListaDecl()));
						}
					}}}}}
	...
	private String arvoreParaFicheiroInstrucao(Instrucao i, Boolean f) {
		{{if (tom_is_sort_Instrucao(i)) {if (tom_is_sort_Instrucao((( gram.i.types.Instrucao )i))) {if (tom_is_fun_sym_Atribuicao((( gram.i.types.Instrucao )(( gram.i.types.Instrucao )i)))) { gram.i.types.OpAtribuicao  tom_op=tom_get_slot_Atribuicao_op((( gram.i.types.Instrucao )i));


				String aux = "" + tom_get_slot_Atribuicao_Id((( gram.i.types.Instrucao )i));

				{{if (tom_is_sort_OpAtribuicao(tom_op)) {if (tom_is_sort_OpAtribuicao((( gram.i.types.OpAtribuicao )tom_op))) {if (tom_is_fun_sym_Atrib((( gram.i.types.OpAtribuicao )(( gram.i.types.OpAtribuicao )tom_op)))) {
aux += "=";}}}}{if (tom_is_sort_OpAtribuicao(tom_op)) {if (tom_is_sort_OpAtribuicao((( gram.i.types.OpAtribuicao )tom_op))) {if (tom_is_fun_sym_Mult((( gram.i.types.OpAtribuicao )(( gram.i.types.OpAtribuicao )tom_op)))) {
aux += "*=";}}}}{if (tom_is_sort_OpAtribuicao(tom_op)) {if (tom_is_sort_OpAtribuicao((( gram.i.types.OpAtribuicao )tom_op))) {if (tom_is_fun_sym_Div((( gram.i.types.OpAtribuicao )(( gram.i.types.OpAtribuicao )tom_op)))) {
aux += "/=";}}}}{if (tom_is_sort_OpAtribuicao(tom_op)) {if (tom_is_sort_OpAtribuicao((( gram.i.types.OpAtribuicao )tom_op))) {if (tom_is_fun_sym_Soma((( gram.i.types.OpAtribuicao )(( gram.i.types.OpAtribuicao )tom_op)))) {
aux += "+=";}}}}{if (tom_is_sort_OpAtribuicao(tom_op)) {if (tom_is_sort_OpAtribuicao((( gram.i.types.OpAtribuicao )tom_op))) {if (tom_is_fun_sym_Sub((( gram.i.types.OpAtribuicao )(( gram.i.types.OpAtribuicao )tom_op)))) {
aux += "-=";}}}}}
				...
				return aux;
			}}}}{if (tom_is_sort_Instrucao(i)) {if (tom_is_sort_Instrucao((( gram.i.types.Instrucao )i))) {if (tom_is_fun_sym_Declaracao((( gram.i.types.Instrucao )(( gram.i.types.Instrucao )i)))) { gram.i.types.DefTipo  tom_tipo=tom_get_slot_Declaracao_DefTipo((( gram.i.types.Instrucao )i));
...
aux += "void ";}}}}}
				...
				aux += arvoreParaFicheiroDeclaracoes(tom_get_slot_Declaracao_Declaracoes((( gram.i.types.Instrucao )i)));
				...
				return aux;
			}}}}{if (tom_is_sort_Instrucao(i)) {if (tom_is_sort_Instrucao((( gram.i.types.Instrucao )i))) {if (tom_is_fun_sym_Funcao((( gram.i.types.Instrucao )(( gram.i.types.Instrucao )i)))) { gram.i.types.DefTipo  tom_tipo=tom_get_slot_Funcao_DefTipo((( gram.i.types.Instrucao )i));
...
aux += "void ";}}}}}
				...
				aux = aux + tom_get_slot_Funcao_Nome((( gram.i.types.Instrucao )i))+ "(";

				aux += arvoreParaFicheiroArgumentos(tom_get_slot_Funcao_Argumentos((( gram.i.types.Instrucao )i)));

				aux += "){\n";

				aux += arvoreParaFicheiroInstrucao(tom_get_slot_Funcao_Instrucao((( gram.i.types.Instrucao )i)),false);
				...
				String aux = arvoreParaFicheiroInstrucao(((tom_is_fun_sym_SeqInstrucao((( gram.i.types.Instrucao )i)))?(tom_get_head_SeqInstrucao_Instrucao((( gram.i.types.Instrucao )i))):((( gram.i.types.Instrucao )i))),false);
				aux += arvoreParaFicheiroInstrucao(((tom_is_fun_sym_SeqInstrucao((( gram.i.types.Instrucao )i)))?(tom_get_tail_SeqInstrucao_Instrucao((( gram.i.types.Instrucao )i))):(tom_empty_list_SeqInstrucao())),false);
...
aux += "*";}}}}{if (tom_is_sort_OpNum(tom_op)) {if (tom_is_sort_OpNum((( gram.i.types.OpNum )tom_op))) {if (tom_is_fun_sym_Divide((( gram.i.types.OpNum )(( gram.i.types.OpNum )tom_op)))) {
aux += "/";}}}}{if (tom_is_sort_OpNum(tom_op)) {if (tom_is_sort_OpNum((( gram.i.types.OpNum )tom_op))) {if (tom_is_fun_sym_Menos((( gram.i.types.OpNum )(( gram.i.types.OpNum )tom_op)))) {
aux += "-";}}}}{if (tom_is_sort_OpNum(tom_op)) {if (tom_is_sort_OpNum((( gram.i.types.OpNum )tom_op))) {if (tom_is_fun_sym_Mod((( gram.i.types.OpNum )(( gram.i.types.OpNum )tom_op)))) {
aux += "%";}}}}}
				...
				return tom_get_slot_Id_Id((( gram.i.types.Expressao )e));
				...
				String aux = tom_get_slot_Call_Id((( gram.i.types.Expressao )e))+ "(";
				...
				return aux;
						...
						String aux = "++" + tom_id;
						return aux;
					}}}}{if (tom_is_sort_OpInc(tom_op)) {if (tom_is_sort_OpInc((( gram.i.types.OpInc )tom_op))) {if (tom_is_fun_sym_Dec((( gram.i.types.OpInc )(( gram.i.types.OpInc )tom_op)))) {

						String aux = "--" + tom_id;
						return aux;
					}}}}}

			}}}}{if (tom_is_sort_Expressao(e)) {if (tom_is_sort_Expressao((( gram.i.types.Expressao )e))) {if (tom_is_fun_sym_IncDepois((( gram.i.types.Expressao )(( gram.i.types.Expressao )e)))) { gram.i.types.OpInc  tom_op=tom_get_slot_IncDepois_OpInc((( gram.i.types.Expressao )e)); String  tom_id=tom_get_slot_IncDepois_Id((( gram.i.types.Expressao )e));{{if (tom_is_sort_OpInc(tom_op)) {if (tom_is_sort_OpInc((( gram.i.types.OpInc )tom_op))) {if (tom_is_fun_sym_Inc((( gram.i.types.OpInc )(( gram.i.types.OpInc )tom_op)))) {
...
return "" + tom_get_slot_Int_Int((( gram.i.types.Expressao )e));}}}}{if (tom_is_sort_Expressao(e)) {if (tom_is_sort_Expressao((( gram.i.types.Expressao )e))) {if (tom_is_fun_sym_Char((( gram.i.types.Expressao )(( gram.i.types.Expressao )e)))) {

String aux = "'" + tom_get_slot_Char_Char((( gram.i.types.Expressao )e))+ "'";return aux;}}}}{if (tom_is_sort_Expressao(e)) {if (tom_is_sort_Expressao((( gram.i.types.Expressao )e))) {if (tom_is_fun_sym_True((( gram.i.types.Expressao )(( gram.i.types.Expressao )e)))) {

return "true";}}}}{if (tom_is_sort_Expressao(e)) {if (tom_is_sort_Expressao((( gram.i.types.Expressao )e))) {if (tom_is_fun_sym_False((( gram.i.types.Expressao )(( gram.i.types.Expressao )e)))) {

return "false";}}}}{if (tom_is_sort_Expressao(e)) {if (tom_is_sort_Expressao((( gram.i.types.Expressao )e))) {if (tom_is_fun_sym_Float((( gram.i.types.Expressao )(( gram.i.types.Expressao )e)))) {

return "" + tom_get_slot_Float_num((( gram.i.types.Expressao )e));}}}}{if (tom_is_sort_Expressao(e)) {if (tom_is_sort_Expressao((( gram.i.types.Expressao )e))) {if (tom_is_fun_sym_Ou((( gram.i.types.Expressao )(( gram.i.types.Expressao )e)))) {
...
aux += "<";}}}}{if (tom_is_sort_OpComp(tom_op)) {if (tom_is_sort_OpComp((( gram.i.types.OpComp )tom_op))) {if (tom_is_fun_sym_MaiorQ((( gram.i.types.OpComp )(( gram.i.types.OpComp )tom_op)))) {
aux += ">=";}}}}{if (tom_is_sort_OpComp(tom_op)) {if (tom_is_sort_OpComp((( gram.i.types.OpComp )tom_op))) {if (tom_is_fun_sym_MenorQ((( gram.i.types.OpComp )(( gram.i.types.OpComp )tom_op)))) {
aux += "<=";}}}}{if (tom_is_sort_OpComp(tom_op)) {if (tom_is_sort_OpComp((( gram.i.types.OpComp )tom_op))) {if (tom_is_fun_sym_Dif((( gram.i.types.OpComp )(( gram.i.types.OpComp )tom_op)))) {
aux += "!=";}}}}{if (tom_is_sort_OpComp(tom_op)) {if (tom_is_sort_OpComp((( gram.i.types.OpComp )tom_op))) {if (tom_is_fun_sym_Igual((( gram.i.types.OpComp )(( gram.i.types.OpComp )tom_op)))) {
aux += "==";}}}}}
...
aux += "void";}}}}}
	...
	private String arvoreParaFicheiroDeclaracoes(Declaracoes d) {
		{{if (tom_is_sort_Declaracoes(d)) {if (tom_is_fun_sym_ListaDecl((( gram.i.types.Declaracoes )(( gram.i.types.Declaracoes )d)))) {if (!( ( tom_is_empty_ListaDecl_Declaracoes((( gram.i.types.Declaracoes )d)) || tom_equal_term_Declaracoes((( gram.i.types.Declaracoes )d), tom_empty_list_ListaDecl()) ) )) {


				return arvoreParaFicheiroDeclaracoes(((tom_is_fun_sym_ListaDecl((( gram.i.types.Declaracoes )d)))?(tom_get_head_ListaDecl_Declaracoes((( gram.i.types.Declaracoes )d))):((( gram.i.types.Declaracoes )d))));
			}}}}{if (tom_is_sort_Declaracoes(d)) {if (tom_is_sort_Declaracoes((( gram.i.types.Declaracoes )d))) {if (tom_is_fun_sym_Decl((( gram.i.types.Declaracoes )(( gram.i.types.Declaracoes )d)))) {
	...
	private String arvoreParaFicheiroArgumentos(Argumentos d) {
		{{if (tom_is_sort_Argumentos(d)) {if (tom_is_fun_sym_ListaArgumentos((( gram.i.types.Argumentos )(( gram.i.types.Argumentos )d)))) {if (!( ( tom_is_empty_ListaArgumentos_Argumentos((( gram.i.types.Argumentos )d)) || tom_equal_term_Argumentos((( gram.i.types.Argumentos )d), tom_empty_list_ListaArgumentos()) ) )) { gram.i.types.Argumentos  tomMatch15_2=((tom_is_fun_sym_ListaArgumentos((( gram.i.types.Argumentos )d)))?(tom_get_tail_ListaArgumentos_Argumentos((( gram.i.types.Argumentos )d))):(tom_empty_list_ListaArgumentos()));if (!( ( tom_is_empty_ListaArgumentos_Argumentos(tomMatch15_2) || tom_equal_term_Argumentos(tomMatch15_2, tom_empty_list_ListaArgumentos()) ) )) { gram.i.types.Argumentos  tomMatch15_3=((tom_is_fun_sym_ListaArgumentos(tomMatch15_2))?(tom_get_tail_ListaArgumentos_Argumentos(tomMatch15_2)):(tom_empty_list_ListaArgumentos()));if ( ( tom_is_empty_ListaArgumentos_Argumentos(tomMatch15_3) || tom_equal_term_Argumentos(tomMatch15_3, tom_empty_list_ListaArgumentos()) ) ) {


				String aux = arvoreParaFicheiroArgumentos(((tom_is_fun_sym_ListaArgumentos((( gram.i.types.Argumentos )d)))?(tom_get_head_ListaArgumentos_Argumentos((( gram.i.types.Argumentos )d))):((( gram.i.types.Argumentos )d))));
				aux += ", \n";
				aux += arvoreParaFicheiroArgumentos(((tom_is_fun_sym_ListaArgumentos(tomMatch15_2))?(tom_get_head_ListaArgumentos_Argumentos(tomMatch15_2)):(tomMatch15_2)));

				return aux;
			}}}}}}{if (tom_is_sort_Argumentos(d)) {if (tom_is_fun_sym_ListaArgumentos((( gram.i.types.Argumentos )(( gram.i.types.Argumentos )d)))) {if (!( ( tom_is_empty_ListaArgumentos_Argumentos((( gram.i.types.Argumentos )d)) || tom_equal_term_Argumentos((( gram.i.types.Argumentos )d), tom_empty_list_ListaArgumentos()) ) )) { gram.i.types.Argumentos  tomMatch15_6=((tom_is_fun_sym_ListaArgumentos((( gram.i.types.Argumentos )d)))?(tom_get_tail_ListaArgumentos_Argumentos((( gram.i.types.Argumentos )d))):(tom_empty_list_ListaArgumentos()));if ( ( tom_is_empty_ListaArgumentos_Argumentos(tomMatch15_6) || tom_equal_term_Argumentos(tomMatch15_6, tom_empty_list_ListaArgumentos()) ) ) {


				return arvoreParaFicheiroArgumentos(((tom_is_fun_sym_ListaArgumentos((( gram.i.types.Argumentos )d)))?(tom_get_head_ListaArgumentos_Argumentos((( gram.i.types.Argumentos )d))):((( gram.i.types.Argumentos )d))));
			}}}}}{if (tom_is_sort_Argumentos(d)) {if (tom_is_sort_Argumentos((( gram.i.types.Argumentos )d))) {if (tom_is_fun_sym_Argumento((( gram.i.types.Argumentos )(( gram.i.types.Argumentos )d)))) { gram.i.types.DefTipo  tom_tipo=tom_get_slot_Argumento_DefTipo((( gram.i.types.Argumentos )d));
...
aux = "void ";}}}}}
				...
				aux += tom_get_slot_Argumento_Id((( gram.i.types.Argumentos )d));
	...
	private String arvoreParaFicheiroParametros(Parametros d) {
		{{if (tom_is_sort_Parametros(d)) {if (tom_is_fun_sym_ListaParametros((( gram.i.types.Parametros )(( gram.i.types.Parametros )d)))) {if (!( ( tom_is_empty_ListaParametros_Parametros((( gram.i.types.Parametros )d)) || tom_equal_term_Parametros((( gram.i.types.Parametros )d), tom_empty_list_ListaParametros()) ) )) { gram.i.types.Parametros  tomMatch17_2=((tom_is_fun_sym_ListaParametros((( gram.i.types.Parametros )d)))?(tom_get_tail_ListaParametros_Parametros((( gram.i.types.Parametros )d))):(tom_empty_list_ListaParametros()));if (!( ( tom_is_empty_ListaParametros_Parametros(tomMatch17_2) || tom_equal_term_Parametros(tomMatch17_2, tom_empty_list_ListaParametros()) ) )) { gram.i.types.Parametros  tomMatch17_3=((tom_is_fun_sym_ListaParametros(tomMatch17_2))?(tom_get_tail_ListaParametros_Parametros(tomMatch17_2)):(tom_empty_list_ListaParametros()));if ( ( tom_is_empty_ListaParametros_Parametros(tomMatch17_3) || tom_equal_term_Parametros(tomMatch17_3, tom_empty_list_ListaParametros()) ) ) {


				String aux = arvoreParaFicheiroParametros(((tom_is_fun_sym_ListaParametros((( gram.i.types.Parametros )d)))?(tom_get_head_ListaParametros_Parametros((( gram.i.types.Parametros )d))):((( gram.i.types.Parametros )d))));

				aux += ", \n";
				aux += arvoreParaFicheiroParametros(((tom_is_fun_sym_ListaParametros(tomMatch17_2))?(tom_get_head_ListaParametros_Parametros(tomMatch17_2)):(tomMatch17_2)));
				return aux;
			}}}}}}{if (tom_is_sort_Parametros(d)) {if (tom_is_fun_sym_ListaParametros((( gram.i.types.Parametros )(( gram.i.types.Parametros )d)))) {if (!( ( tom_is_empty_ListaParametros_Parametros((( gram.i.types.Parametros )d)) || tom_equal_term_Parametros((( gram.i.types.Parametros )d), tom_empty_list_ListaParametros()) ) )) { gram.i.types.Parametros  tomMatch17_6=((tom_is_fun_sym_ListaParametros((( gram.i.types.Parametros )d)))?(tom_get_tail_ListaParametros_Parametros((( gram.i.types.Parametros )d))):(tom_empty_list_ListaParametros()));if ( ( tom_is_empty_ListaParametros_Parametros(tomMatch17_6) || tom_equal_term_Parametros(tomMatch17_6, tom_empty_list_ListaParametros()) ) ) {


				return arvoreParaFicheiroParametros(((tom_is_fun_sym_ListaParametros((( gram.i.types.Parametros )d)))?(tom_get_head_ListaParametros_Parametros((( gram.i.types.Parametros )d))):((( gram.i.types.Parametros )d))));
	...
	public static class refactCondNeg extends tom.library.sl.AbstractStrategyBasic {public refactCondNeg() {super(tom_make_Identity());}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChildren = new tom.library.sl.Visitable[getChildCount()];stratChildren[0] = super.getChildAt(0);return stratChildren;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}@SuppressWarnings("unchecked")public <T> T visitLight(T v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (tom_is_sort_Instrucao(v)) {return ((T)visit_Instrucao((( gram.i.types.Instrucao )v),introspector));}if (!(( null  == environment))) {return ((T)any.visit(environment,introspector));} else {return any.visitLight(v,introspector);}}@SuppressWarnings("unchecked")public  gram.i.types.Instrucao  _visit_Instrucao( gram.i.types.Instrucao  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!(( null  == environment))) {return (( gram.i.types.Instrucao )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);}}@SuppressWarnings("unchecked")public  gram.i.types.Instrucao  visit_Instrucao( gram.i.types.Instrucao  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if (tom_is_sort_Instrucao(tom__arg)) {if (tom_is_sort_Instrucao((( gram.i.types.Instrucao )tom__arg))) {if (tom_is_fun_sym_If((( gram.i.types.Instrucao )(( gram.i.types.Instrucao )tom__arg)))) { gram.i.types.Expressao  tomMatch18_4=tom_get_slot_If_Condicao((( gram.i.types.Instrucao )tom__arg)); gram.i.types.LComentarios  tom_c1=tom_get_slot_If_c1((( gram.i.types.Instrucao )tom__arg)); gram.i.types.LComentarios  tom_c2=tom_get_slot_If_c2((( gram.i.types.Instrucao )tom__arg)); gram.i.types.LComentarios  tom_c3=tom_get_slot_If_c3((( gram.i.types.Instrucao )tom__arg));if (tom_is_sort_Expressao(tomMatch18_4)) {if (tom_is_fun_sym_Nao((( gram.i.types.Expressao )tomMatch18_4))) { gram.i.types.Expressao  tom_e=tom_get_slot_Nao_Expressao(tomMatch18_4); gram.i.types.LComentarios  tom_c4=tom_get_slot_If_c4((( gram.i.types.Instrucao )tom__arg)); gram.i.types.LComentarios  tom_c5=tom_get_slot_If_c5((( gram.i.types.Instrucao )tom__arg)); gram.i.types.Instrucao  tom_then=tom_get_slot_If_Instrucao1((( gram.i.types.Instrucao )tom__arg)); gram.i.types.Instrucao  tom_els=tom_get_slot_If_Instrucao2((( gram.i.types.Instrucao )tom__arg));
                ...
                if(tom_els!= tom_make_Exp(tom_make_Empty())){
					...
					return tom_make_If(tom_c1,tom_c2,tom_c3,tom_make_Nao(tom_e),tom_c4,tom_c5,tom_then,tom_els);
	...
	private static int contaArgumentos(Argumentos args){
		{{if (tom_is_sort_Argumentos(args)) {if (tom_is_fun_sym_ListaArgumentos((( gram.i.types.Argumentos )(( gram.i.types.Argumentos )args)))) {if (!( ( tom_is_empty_ListaArgumentos_Argumentos((( gram.i.types.Argumentos )args)) || tom_equal_term_Argumentos((( gram.i.types.Argumentos )args), tom_empty_list_ListaArgumentos()) ) )) {
			...
			}}}}{if (tom_is_sort_Argumentos(args)) {if (tom_is_sort_Argumentos((( gram.i.types.Argumentos )args))) {if (tom_is_fun_sym_Argumento((( gram.i.types.Argumentos )(( gram.i.types.Argumentos )args)))) { String  tom_id=tom_get_slot_Argumento_Id((( gram.i.types.Argumentos )args));



				auxFunc.adicionaOperando(tom_id);
                auxFunc.incLocalVars(tom_id);
	...
	private static void resolveDecls(Declaracoes decls){
		{{if (tom_is_sort_Declaracoes(decls)) {if (tom_is_sort_Declaracoes((( gram.i.types.Declaracoes )decls))) {if (tom_is_fun_sym_Decl((( gram.i.types.Declaracoes )(( gram.i.types.Declaracoes )decls)))) { String  tom_id=tom_get_slot_Decl_Id((( gram.i.types.Declaracoes )decls)); gram.i.types.Expressao  tom_exp=tom_get_slot_Decl_Expressao((( gram.i.types.Declaracoes )decls));
