// $ANTLR 3.2 Sep 23, 2009 12:02:23 gram/i.g 2015-12-01 12:03:31
 package gram; 
...
public class iParser extends Parser {
    ...
    public final iParser.declaracao_return declaracao() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: c2, c4, c3, c1, dec_nodo, idTipo
            // token labels: 
    ...
    public final iParser.funcao_return funcao() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: c7, c6, c3, ID, c5, blocoCodigo, c4, c2, idTipo, c1, argumentos
            // token labels: 
        ...
        try {
            ...
            switch (alt10) {
                case 1 :
                    ...
                    // AST REWRITE
                    // elements: else_, c3, blocoCodigo, c5, c2, condicao, c1, c4
                    // token labels: 
                ...
                case 2 :
                    ...
                    // AST REWRITE
                    // elements: condicao, c2, blocoCodigo, c1, c5, c4, c3
                    // token labels: 
                    // rule labels: retval, c1, c2, c5, c4, c3
                    // token list labels: 
                    // rule list labels: 
    ...
    public final iParser.for__return for_() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: expressao, condicao, c1, c5, c8, blocoCodigo, c2, c4, c3, c7, c6, for_declaracao
            // token labels: 
    ...
    public final iParser.while__return while_() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: blocoCodigo, condicao, c1, c5, c6, c3, c4, c2
            // token labels: 
    ...
    public final iParser.call_return call() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: c4, ID, c1, c3, c2, c5, parametros
            // token labels: 
            // rule labels: retval, c1, c2, c5, c4, c3
            // token list labels: 
            // rule list labels: 
    ...
    public final iParser.print__return print_() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: c3, c4, c2, c1, c5, expressao
            // token labels: 
            // rule labels: retval, c1, c2, c5, c4, c3
            // token list labels: 
            // rule list labels: 
    ...
    public final iParser.input__return input_() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: c2, c1, c4, c5, c3, idTipo
            // token labels: 
            // rule labels: retval, c1, c2, c5, c4, c3
            // token list labels: 
            // rule list labels: 
        ...
        try {
            ...
            switch (alt17) {
                case 1 :
                    ...
                    // AST REWRITE
                    // elements: c3, condicao_ou, c1, expressao, c4, c2, condicao
                    // token labels: 
                    // rule labels: retval, c1, c2, c4, c3
                    // token list labels: 
                    // rule list labels: 
            	...
            	case 1 :
            	    ...
            	    switch (alt22) {
            	        case 1 :
            	            ...
            	            // AST REWRITE
            	            // elements: c2, c1, condicao_igualdade, e
            	            // token labels: 
            	        ...
            	        case 2 :
            	            ...
            	            // AST REWRITE
            	            // elements: c2, condicao_igualdade, e, c2
            	            // token labels: 
    ...
    public final iParser.atribuicao_return atribuicao() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: c4, condicao, opAtribuicao, c3, c1, ID, c2
            // token labels: 
            // rule labels: retval, c1, c2, c4, c3
            // token list labels: 
            // rule list labels: 
