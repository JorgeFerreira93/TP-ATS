// $ANTLR 3.2 Sep 23, 2009 12:02:23 gram/i.g 2016-01-01 13:25:14
 package gram; 
...
public class iParser extends Parser {
    ...
    public final iParser.declaracao_return declaracao() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: c3, c4, c2, dec_nodo, c1, idTipo
            // token labels: 
    ...
    public final iParser.funcao_return funcao() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: c6, c5, c3, c2, c1, ID, c7, argumentos, blocoCodigo, c4, idTipo
            // token labels: 
        ...
        try {
            ...
            switch (alt10) {
                case 1 :
                    ...
                    // AST REWRITE
                    // elements: blocoCodigo, c2, condicao, c3, c1, else_, c5, c4
                    // token labels: 
                ...
                case 2 :
                    ...
                    // AST REWRITE
                    // elements: c5, c3, c2, blocoCodigo, c4, condicao, c1
                    // token labels: 
                    // rule labels: retval, c1, c2, c5, c4, c3
                    // token list labels: 
                    // rule list labels: 
    ...
    public final iParser.for__return for_() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: c6, c4, c7, expressao, for_declaracao, c3, c5, c2, blocoCodigo, c1, condicao, c8
            // token labels: 
    ...
    public final iParser.while__return while_() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: c1, c5, c3, c4, condicao, blocoCodigo, c2, c6
            // token labels: 
    ...
    public final iParser.call_return call() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: parametros, c1, c5, c2, c3, ID, c4
            // token labels: 
            // rule labels: retval, c1, c2, c5, c4, c3
            // token list labels: 
            // rule list labels: 
    ...
    public final iParser.print__return print_() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: c5, expressao, c2, c4, c3, c1
            // token labels: 
            // rule labels: retval, c1, c2, c5, c4, c3
            // token list labels: 
            // rule list labels: 
    ...
    public final iParser.input__return input_() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: c3, c4, c5, c1, c2, idTipo
            // token labels: 
            // rule labels: retval, c1, c2, c5, c4, c3
            // token list labels: 
            // rule list labels: 
        ...
        try {
            ...
            switch (alt17) {
                case 1 :
                    ...
                    // AST REWRITE
                    // elements: c3, c4, condicao, c2, c1, expressao, condicao_ou
                    // token labels: 
                    // rule labels: retval, c1, c2, c4, c3
                    // token list labels: 
                    // rule list labels: 
            	...
            	case 1 :
            	    ...
            	    switch (alt22) {
            	        ...
            	        case 2 :
            	            ...
            	            // AST REWRITE
            	            // elements: e, c2, c2, condicao_igualdade
            	            // token labels: 
    ...
    public final iParser.atribuicao_return atribuicao() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: c4, condicao, c2, ID, opAtribuicao, c3, c1
            // token labels: 
            // rule labels: retval, c1, c2, c4, c3
            // token list labels: 
            // rule list labels: 
